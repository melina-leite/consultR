...
# fazendo a relação usando formato de fórmula:
...
Essa função é particularmente importante para vermos de uma só vez as correlações entre a variável dependente e as variáveis independentes, assim como as correçaões entre as variáveis independentes. 

```{r}
pairs(pardais[ ,3:8], upper.panel = cor(pardais[,3:8]))
```

<!-- CONTINUAR AQUI, USAR FUNCOES DA IENO 2015 PARA PAIRS? -->
