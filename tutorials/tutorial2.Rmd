...
```{r, echo=F}
# para testar os comandos do roteiro rodando no computador
...
# fazendo graficos separadaos para variável observador 
# pacote lattice
...
Dê o comando `demo(colors)` para ter uma noção da quantidade de cores possíveis a serem chamadas por nome. Existem diferentes paletas de cores formas de defini-las.
...
- Muitos dos exemplos desta aula foram tirados dos roteiros e exercícios do site da [disciplina de R do IB-USP](http://ecologia.ib.usp.br/bie5782/doku.php?id=bie5782:02_tutoriais:tutorial4:start). Vale a pena conferir na íntegra os roteiros 4 e 5.

- Capítulo 6 da Apostila de R da disciplina da USP, sobre [gráficos avançados](http://ecologia.ib.usp.br/bie5782/doku.php?id=bie5782:03_apostila:10-graficos02)

- Exercícios sobre [parâmetros gráficos](http://r-exercises.com/2016/03/24/graphics-parameters-exercises/) 

- O pacote [ggplot2](http://ggplot2.org/) é uma nova forma de fazer gráficos seguindo uma sintaxe um tanto diferente do pacote base. Vale a pena conferir e testar alguns exemplos!

- Recomendo ler o Capítulo 5 do livro "The R Book" do Crawley sobre gráficos. Se ainda não baixo o livro, [baixe aqui!]((http://gen.lib.rus.ec/book/index.php?md5=e09db860b99f0710ec5746796c101d59)) 

- Artigo sobre como explorar dados e evitar problemas estatísticos comuns: [Zuur et al. 2010](https://www.dropbox.com/s/72bws84hemahlum/zuur%20et%20al%202010%20protocol%20data%20exploration%20to%20avoid%20common%20statistical%20problems.pdf?dl=0)

- Mais dois livros bem interessantes sobre análises de dados ecológicos e R:  
    - Zuur et al. 2009. [Analysing Ecological Data](https://www.dropbox.com/s/zato5f7nnai7h8g/Zuur%2C%20Ieno%2C%20Smith_2007_Analysing%20ecological%20data.pdf?dl=0). Capítulo 4 fala sobre análise exploratória e gráficos  
    - Zuur et al. 2009. [A beginner's guide to R](https://www.dropbox.com/s/g0hn0w9f5rn3i91/Zuur%2C%20Ieno%2C%20Meesters_2009_A%20Beginner%27s%20Guide%20to%20R.pdf?dl=0). Capitulos 5 e 7 sobre gráficos.  
